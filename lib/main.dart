...
void main() async {
  ...
  // (your project previously called Hive.registerAdapters(); keep it)
...
class _AppInitializationWrapperState extends State<AppInitializationWrapper> {
  ...
  Future<void> _checkInitialization() async {
    try {
      ...
      // You can improve this later by adding retry logic.
      setState(() {
        _isLoading = false;
        _isInitialized = false;
      });
      // For dev: print error so you can see logs quickly
      // (In production you might show a nicer retry UI)
      // ignore: avoid_print
  ...
  Widget build(BuildContext context) {
    ...
    // App is initialized, show main navigation screen (keeps all tabs)
    return const MainNavigationScreen();
  }
}

// -----------------------------------------------------------------------------
// Main navigation shell (kept from your old main.dart)
// -----------------------------------------------------------------------------
